      ...
      <div className="container flex flex-col md:flex-row items-center gap-10 py-12">
        ...
        <div className="banner flex-1">
          ...
          <p className="mid text-base text-gray-700 leading-relaxed mb-6">
            At The Durgs, we believe great food brings people together. Located in the heart of Coimbatore, we serve a variety of hand-crafted Indian and fusion dishes, made with the freshest ingredients and traditional techniques.
            <br />
